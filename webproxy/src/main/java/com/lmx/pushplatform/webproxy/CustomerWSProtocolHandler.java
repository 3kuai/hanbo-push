...
//
//public class CustomerWSProtocolHandler extends SimpleChannelInboundHandler<WebSocketFrame> {
//    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerWSProtocolHandler.class);
//    /**
//     * appKey映射多个客户端
//     */
